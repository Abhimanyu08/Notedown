CREATE OR REPLACE FUNCTION "public"."search"("user_id" "text", "search_term" "text", "cursor" double precision) RETURNS TABLE("id" bigint, "created_by" "uuid", "title" "text", "description" "text", "published" boolean, "created_at" "text", "published_on" "text", "language" character varying, "upvote_count" bigint, "author" character varying, "timestamp" "text")
    LANGUAGE "plpgsql"
    AS $$
    BEGIN
        RETURN QUERY
